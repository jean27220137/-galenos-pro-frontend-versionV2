...
@Component({
  ...
  template: `
    <div class="p-6">
      ...
      <p-table [value]="solicitudes" [loading]="cargando"
        ...
        <ng-template pTemplate="header">
          <tr>
            ...
            <th style="text-align:center">Farmacia ID</th>
            <th>Estado</th>
      ...
      <div style="margin-top:1rem;padding:12px 16px;background:#FFF7ED;border:1px solid #FED7AA;
                  border-radius:8px;font-size:0.8rem;color:#92400E;display:flex;gap:8px;align-items:flex-start">
        <i class="pi pi-info-circle" style="margin-top:1px"></i>
        <span>
          Las solicitudes se procesan automáticamente cuando el sistema recibe la notificación.
          Una vez procesada, se genera una Nota de Salida visible en <strong>Notas de Salida</strong>.
        </span>
      </div>
    </div>
  `
